			...
			if (pt_glb->Jf_input_type < 3) {
				...
				if (pt_glb->Jf_input_type == 0) {
					if (pt_glb->Jf_input_component == 'x') {
						DJfx(i, j, k) = cos(PI * pt_glb->Jf_rotate_xy / 180.) * pt_glb->Jf_input_amp * temporal_var;
						DJfy(i, j, k) = sin(PI * pt_glb->Jf_rotate_xy / 180.) * pt_glb->Jf_input_amp * temporal_var;
					}
					else if (pt_glb->Jf_input_component == 'y') {
						DJfx(i, j, k) = cos(PI * (pt_glb->Jf_rotate_xy +90.)/ 180.) * pt_glb->Jf_input_amp * temporal_var;
						DJfy(i, j, k) = sin(PI * (pt_glb->Jf_rotate_xy +90.)/ 180.) * pt_glb->Jf_input_amp * temporal_var;
					}
